...
const LogoHeader = () => {
  return (
    <header className=" flex flex-row justify-between p-4 bg-blue-800 text-white">
      {/* Placeholder for logo */}
      <Image src="/assets/images/examportal.png" width={200} height={100} alt="Org Logo" className="pb-4"/>
      <h2 className="my-[70px] text-4xl font-semibold">Personality Test</h2>
      <h2 className='text-blue-800 '>abcd</h2>
    </header>
  );
};
    ...
    <div className="flex flex-col h-screen bg-slate-200">
      ...
      {hasReadInstructions ? (
        ...
        <main className="flex-grow p-8 bg-slate-200">
          ...
          <Link href="/user/demo" className='ml-7'>
            <button className='bg-red-500 hover:bg-slate-700 p-2 rounded-md' onClick={handleExit}>Demo Test</button>
            </Link>
            <ActionButton
              text="Start Test"
